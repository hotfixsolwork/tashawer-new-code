...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/closed-projects', 'AdminProjectController@closed_projects')->name('closed_projects');
	Route::post('/projects/approval-status', 'AdminProjectController@project_approval')->name('project_approval');
	
	
	// project types
	Route::get('project-types', 'AdminProjectController@project_types')->name('project_types');
	Route::post('project-types/store', 'AdminProjectController@project_types_store')->name('project_types.store');
	Route::get('project-types/destroy/{id}', 'AdminProjectController@project_type_destroy')->name('project_types.destroy');
  ...
  Route::controller('NewsletterController')->group(function () {
	...
	Route::get('/recharge-requests', 'WalletController@wallet_transaction_history')->name('wallet-history.index');
	Route::post('/wallet-request/approve', 'WalletController@waletApprove')->name('wallet.request.approve');
	Route::post('/wallet-request/reject', 'WalletController@waletReject')->name('wallet.request.reject');
