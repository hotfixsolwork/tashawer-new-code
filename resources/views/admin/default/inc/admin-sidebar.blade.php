            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                @if(auth()->user()->can('show all projects')
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('closed_projects') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Closed Project')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('project_types') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Project Types')}}</span>
                                </a>
                            </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('wallet-history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['wallet-history.index'])}}">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Wallet Recharge')}}</span>
                    </a>
                </li>
                ...
                @if(auth()->user()->can('show all freelancers')
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Consultants')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_freelancers') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_freelancers', 'freelancer_info_show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All Consultants')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('skills.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['skills.index', 'skills.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Consultant Skills')}}</span>
                                </a>
                            </li>
                            @endcan
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('reviews.freelancer') }}" class="aiz-side-nav-link {{ areActiveRoutes(['reviews.freelancer', 'freelancer_review_details'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Consultants Reviews')}}</span>
                                </a>
                            </li>
                            @endcan
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('withdraw_request.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pay_to_freelancer'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Consultant Withdraw Requests')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('freelancer_payment.index')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('consultant Payouts')}}</span>
                                </a>
                            </li>
                            @endcan
