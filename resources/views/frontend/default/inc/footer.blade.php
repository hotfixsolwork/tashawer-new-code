            ...
            <div class="container">
                <div class="aiz-front-widget mb-5">
                    ...
                    <div class="fs-14 text-soft-info-light">
                        @php
                            echo get_setting('about_description_footer', 'ar');
                        @endphp
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-3 col-sm-6">
                        <div class="aiz-front-widget mb-5">
                            <h4 class="title">{{ get_setting('widget_one', 'ar') }}</h4>
                            <ul class="menu">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="aiz-front-widget mb-5">
                            <h4 class="title">{{ get_setting('widget_two', 'ar') }}</h4>
                            <ul class="menu">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="aiz-front-widget mb-5">
                            <h4 class="title">{{ get_setting('widget_three', 'ar') }}</h4>
                            <ul class="menu">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="aiz-front-widget mb-5">
                            <h4 class="title">{{ get_setting('widget_four', 'ar') }}</h4>
                            <ul class="menu">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="aiz-front-widget mb-5">
                            <h4 class="title">{{ get_setting('social_widget_title', 'ar') }}</h4>
