				      ...
				      <div class="intro-banner-search-form margin-top-95">
					   ...
					   <!-- Search Field -->
						...
						<div class="input-with-icon">
							<input id="autocomplete-input" type="text" placeholder="{{ translate('I am looking for') }}">
							<i class="las la-map-marker-alt la-2x"></i>
						</div>
					    </div>
                        ...
                        <div class="intro-search-button">
                            <button class="button ripple-effect" style="border-radius: 10px">{{ translate ('Search') }}</button>
                        </div>
				      </div>
			        </div>
                    </form>
