							...
							<div class="form-group mb-4">
								<div class="aiz-radio-inline">
									<label class="aiz-radio">
										<input type="radio" name="user_types[]" value="freelancer" @if($type=='freelancer') checked @endif> {{ translate('As A Consultant') }}
										<span class="aiz-rounded-check"></span>
									</label>
									<label class="aiz-radio">
										<input type="radio" name="user_types[]" value="client" @if($type=='client') checked @endif> {{ translate('As A Client') }}
										<span class="aiz-rounded-check"></span>
									</label>
								</div>
							</div>
