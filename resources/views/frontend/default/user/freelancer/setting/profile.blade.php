                                        ...
                                        <label id="nameLabel" class="form-label">
                                         ...
                                         <div class="form-group">
                                             <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text">{{ translate ('SAR') }}</span>
                                                </div> 
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row gutters-10">
                                        @foreach ($user_profile->user->userPortfolios as $key => $portfolio)
                                            @php
                                                ...
                                                $ext = strtolower(pathinfo($portfolio->photo, PATHINFO_EXTENSION));
                                                $ext_two = strtolower(pathinfo($portfolio->photo, PATHINFO_EXTENSION));
                                            @endphp
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                ...
                                                <div class="text-center mb-2">
                                                    <a href="{{ asset('public/assets/backend/default/' . $portfolio->photo) }}"
                                                        class="btn btn-primary btn-sm">{{ translate ('View File') }}</a>
                                                </div>
                                                @endif

                                                <div
                                                    class="card position-relative text-reset mb-3 rounded-1 border-gray-light">
                                                    @if (in_array($ext, $extensions))
                                                        <img class="img-fit mw-100"
                                                            src="{{ asset('public/assets/backend/default/' . $portfolio->photo) }}"
                                                            height="240">
                                                    @endif
                            ...
                            @if ($user_profile->user->userPackage->portfolio_add_limit > count($user_profile->user->userPortfolios))
                                <form action="{{ route('user_profile.portfolio_add') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label id="usernameLabel" class="form-label">{{ translate('Category') }}<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label class="form-label">{{ translate('Choose File') }}</label>
                                            <!--<div class="input-group" data-toggle="aizuploader" data-type="image">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text bg-soft-secondary font-weight-medium">
                                                            {{ translate('Browse') }}</div>
                        ...
                        <div class="card-body">
                            ...
                            @if ($user_profile->user->userPackage->job_exp_limit > count($user_profile->user->workExperiences))
                                <form action="{{ route('user_profile.work_experience_add') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label id="usernameLabel" class="form-label">{{ translate('Designation') }}<span
                                                class="text-danger">*</span></label>
                    ...
                    <div class="card rounded-2 border-gray-light">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('user_profile.education_info_add') }}" method="POST"
                                ...
                                @csrf
                                <div class="form-group">
                                    <label id="usernameLabel" class="form-label">{{ translate('School Name') }}<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label id="usernameLabel" class="form-label">{{ translate('Passing Year') }}<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label id="usernameLabel" class="form-label">{{ translate('Country') }}<span
                                            class="text-danger">*</span></label>
                                    <select class="form-control aiz-selectpicker" id="school_country_id"
